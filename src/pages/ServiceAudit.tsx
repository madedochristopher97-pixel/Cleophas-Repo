...
import { ChevronRight, ShieldCheck, CheckCircle2, ArrowRight, Shield } from 'lucide-react';
      ...
      <section className="bg-[#004524] text-white py-24 md:py-32 relative overflow-hidden">
        ...
        <div className="max-w-screen-2xl mx-auto px-8 relative z-10">
          <nav className="mb-8 flex items-center space-x-2 text-[#aef2c0]/80 text-sm font-sans uppercase tracking-widest">
            ...
            <ChevronRight className="w-4 h-4" />
            <span className="text-[#aef2c0]">Audit & Assurance</span>
          </nav>
          <div className="max-w-4xl">
            ...
            >
              Audit & <br/>
              <span className="italic font-light text-[#C9981A]">Assurance.</span>
            </motion.h1>
            <motion.p 
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              Beyond compliance, we provide deep insights into your financial health, ensuring transparency and building trust with your stakeholders.
            </motion.p>
          </div>
        </div>
      </section>
      ...
      <section className="py-24 px-8 bg-[#FBF9F9]">
        <div className="max-w-screen-xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-16">
          <div className="lg:col-span-8 space-y-12">
            <div>
              <h2 className="font-serif text-3xl md:text-4xl font-bold text-[#004524] mb-6">Uncovering Value Through Precision</h2>
              <p className="font-sans text-lg text-[#1B1C1C]/80 leading-relaxed mb-6">
                In today's complex regulatory environment, an audit is more than a statutory obligation—it is a critical lens through which to view your business's operational integrity and financial health. Our approach to audit and assurance goes beyond the numbers. We seek to understand the intricate mechanics of your organization, identifying risks before they materialize and uncovering opportunities for operational refinement.
              </p>
              <p className="font-sans text-lg text-[#1B1C1C]/80 leading-relaxed">
                We leverage advanced analytics and forensic methodologies to provide a clear, unvarnished picture of your financial standing. This commitment to rigorous transparency not only satisfies regulatory demands but fortifies the trust of your investors, board members, and stakeholders.
              </p>
            </div>
          ...
          <div className="lg:col-span-4">
            <div className="bg-[#004524] rounded-2xl p-10 text-white sticky top-32 shadow-2xl">
              <ShieldCheck className="w-12 h-12 text-[#C9981A] mb-6" />
              <h3 className="font-serif text-2xl font-bold mb-4">Secure Your Legacy</h3>
              <p className="font-sans text-[#FBF9F9]/80 mb-8 leading-relaxed">
                Speak with our lead assurance partners to discuss how we can fortify your financial reporting framework.
              </p>
