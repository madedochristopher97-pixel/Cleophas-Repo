...
import { ShieldCheck, Wallet, BarChart3, TrendingUp, ArrowRight, ChevronRight, Quote, Shield } from 'lucide-react';
      ...
      <section className="bg-surface-container-lowest py-24 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-8 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-fr">
            ...
            {/* Card 4 - Wide Bottom (Corporate Finance) */}
            <div className="md:col-span-3 md:row-span-1 group p-8 md:p-10 bg-surface border-l-4 border-transparent hover:border-[#C9981A] hover:bg-surface-container-low transition-all duration-300 rounded-2xl shadow-sm flex flex-col md:flex-row items-start md:items-center justify-between relative overflow-hidden gap-8">
              <div className="flex flex-col md:flex-row items-start md:items-center gap-6 md:gap-8 relative z-10 w-full">
                ...
                <div className="flex-grow">
                  ...
                  <p className="text-on-surface-variant leading-relaxed text-base font-body max-w-3xl">High-level advisory for mergers, acquisitions, and long-term capital structural growth to ensure your legacy endures.</p>
                </div>
                <Link to="/services/corporate-finance" className="shrink-0 bg-primary text-white px-8 py-4 rounded-xl font-bold hover:bg-[#1B5E38] transition-colors relative z-10 flex items-center gap-2 mt-4 md:mt-0">
